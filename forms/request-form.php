...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // From & To
        $mail->setFrom('harry@astraresults.com', 'Aqua Pro');
        $mail->addAddress('carvel@astraresults.com');

        // Add CC recipients
        $mail->addCC('clint@astraresults.com');
        $mail->addCC('angelo@astraresults.com');
